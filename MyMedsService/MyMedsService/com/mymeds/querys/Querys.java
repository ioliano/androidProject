...
public class Querys {
	...
	public static String getQueryInsertMedUtilizador(Long idUtilizador, Long idMedicamento, Date dataInicio, Integer numDoses, Integer horasIntervalo){
		...
		/** Campos opcionais **/
		if(dataInicio!=null && horasIntervalo != null){
	...
	public static String getQueryUpdateMedUtilizador(RlUtilizadorMedicamento rlUserMed){
		...
		hql.append(rlUserMed.getDataUltimaToma()!=null ? " DATA_ULTIMA_TOMA = TO_DATE('" + dateFormat.format(rlUserMed.getDataUltimaToma()) + "','yyyy-MM-dd HH24:mi:ss'), " : ""); 
		...
		hql.append(" WHERE  ");
		hql.append(" ENABLED = " + rlUserMed.getEnabled() + " "); 
