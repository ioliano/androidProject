...
import com.mymeds.inout.DeleteMedicamentoIn;
import com.mymeds.inout.DeleteMedicamentoOut;
...
import com.mymeds.inout.UpdateDesactivarAlarmeIn;
import com.mymeds.inout.UpdateDesactivarAlarmeOut;
import com.mymeds.inout.UpdateMedicamentoIn;
import com.mymeds.inout.UpdateMedicamentoOut;
import com.mymeds.inout.UpdateTomarMedicamentoIn;
import com.mymeds.inout.UpdateTomarMedicamentoOut;
...
public class MyMedsAPI {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/updateTomarMedicamento")
	public String updateTomarMedicamento(String inputJsonObj) {
		log.info("[MyMedsService.updateTomarMedicamento]Entrada na consulta");
		StringBuilder result = new StringBuilder(ServerConstants.JSON_OPEN_TAG);
		try {
			/** Inicia o contexto Gson **/
			GsonBuilder gsonBuilder = new GsonBuilder();
			...
			/** cria o objeto de rececao de episodios **/
			UpdateTomarMedicamentoIn input = gson.fromJson(inputJsonObj, UpdateTomarMedicamentoIn.class);
			...
			/** Cria estrutura de output **/
			UpdateTomarMedicamentoOut output = new UpdateTomarMedicamentoOut();
			DBService dBService = new DBService();
			output = dBService.updateTomarMedicamento(input);

			/** Devolve o resultado do insert **/
			log.debug("[MyMedsService.updateTomarMedicamento]Output: " + gson.toJson(output));
			return gson.toJson(output);

		} catch (JsonSyntaxException ex) {
			log.error("[MyMedsService.updateTomarMedicamento]Error ", ex);
			result.append(new Result(ResultCodes.ERRO_VALIDACAO.getCode(), "Erro a na construção do input!"));
			result.append("[JsonSyntaxException]" + ex);
			result.append(ServerConstants.JSON_CLOSE_TAG);
		} catch (Exception ex) {
			...
			log.info("[MyMedsService.updateTomarMedicamento]Saida da consulta");
		}
		return result.toString();	
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/updateDesactivarAlarme")
	public String updateDesactivarAlarme(String inputJsonObj) {
		log.info("[MyMedsService.updateDesactivarAlarme]Entrada na consulta");
		StringBuilder result = new StringBuilder(ServerConstants.JSON_OPEN_TAG);
		try {
			/** Inicia o contexto Gson **/
			GsonBuilder gsonBuilder = new GsonBuilder();
			...
			/** cria o objeto de rececao de episodios **/
			UpdateDesactivarAlarmeIn input = gson.fromJson(inputJsonObj, UpdateDesactivarAlarmeIn.class);
			...
			/** Cria estrutura de output **/
			UpdateDesactivarAlarmeOut output = new UpdateDesactivarAlarmeOut();
			DBService dBService = new DBService();
			output = dBService.updateDesactivarAlarme(input);

			/** Devolve o resultado do insert **/
			log.debug("[MyMedsService.updateDesactivarAlarme]Output: " + gson.toJson(output));
			return gson.toJson(output);

		} catch (JsonSyntaxException ex) {
			log.error("[MyMedsService.updateDesactivarAlarme]Error ", ex);
			result.append(new Result(ResultCodes.ERRO_VALIDACAO.getCode(), "Erro a na construção do input!"));
			result.append("[JsonSyntaxException]" + ex);
			result.append(ServerConstants.JSON_CLOSE_TAG);
		} catch (Exception ex) {
			...
			log.info("[MyMedsService.updateDesactivarAlarme]Saida da consulta");
		}
		return result.toString();	
	}
	...
	public String deleteMedicamento(String inputJsonObj) {
		log.info("[MyMedsService.deleteMedicamento]Entrada na consulta");
		StringBuilder result = new StringBuilder(ServerConstants.JSON_OPEN_TAG);
		try {
			/** Inicia o contexto Gson **/
			GsonBuilder gsonBuilder = new GsonBuilder();
			...
			/** cria o objeto de rececao de episodios **/
			DeleteMedicamentoIn input = gson.fromJson(inputJsonObj, DeleteMedicamentoIn.class);
			...
			/** Cria estrutura de output **/
			DeleteMedicamentoOut output = new DeleteMedicamentoOut();
			DBService dBService = new DBService();
			output = dBService.deleteMedicamento(input);

			/** Devolve o resultado do insert **/
			log.debug("[MyMedsService.deleteMedicamento]Output: " + gson.toJson(output));
			return gson.toJson(output);

		} catch (JsonSyntaxException ex) {
			log.error("[MyMedsService.deleteMedicamento]Error ", ex);
			result.append(new Result(ResultCodes.ERRO_VALIDACAO.getCode(), "Erro a na construção do input!"));
			result.append("[JsonSyntaxException]" + ex);
			result.append(ServerConstants.JSON_CLOSE_TAG);
		} catch (Exception ex) {
			...
			log.info("[MyMedsService.deleteMedicamento]Saida da consulta");
		}
		return result.toString();	
	}
