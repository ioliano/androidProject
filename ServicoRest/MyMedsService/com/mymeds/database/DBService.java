...
public class DBService {
	...
	/**
	 * Update tomar medicamento
	 * @param input
	 * @return
	 * @throws Exception 
	 */
	public UpdateTomarMedicamentoOut updateTomarMedicamento(UpdateTomarMedicamentoIn input) throws Exception{
		UpdateTomarMedicamentoOut output = new UpdateTomarMedicamentoOut();
		DataBaseConfig dbConfig = new DataBaseConfig();
		String query = null;
		
		if(input!=null && input.getRlUtilizadorMedicamento() !=null){
			query = Querys.getQueryTomarMedicamento(input.getRlUtilizadorMedicamento());	
		}
	...
	/**
	 * Update desactivar Alarme
	 * @param input
	 * @return
	 * @throws Exception 
	 */
	public UpdateDesactivarAlarmeOut updateDesactivarAlarme(UpdateDesactivarAlarmeIn input) throws Exception{
		UpdateDesactivarAlarmeOut output = new UpdateDesactivarAlarmeOut();
		DataBaseConfig dbConfig = new DataBaseConfig();
		String query = null;
		
		if(input!=null && input.getRlUtilizadorMedicamento() !=null){
			query = Querys.getQueryDesactivarAlarme(input.getRlUtilizadorMedicamento());	
		}
	 ...
	 * @throws Exception 
	 */
	public DeleteMedicamentoOut deleteMedicamento(DeleteMedicamentoIn input) throws Exception{
		DeleteMedicamentoOut output = new DeleteMedicamentoOut();
		DataBaseConfig dbConfig = new DataBaseConfig();
		String query = null;
		
		if(input!=null && input.getRlUtilizadorMedicamento() !=null){
			query = Querys.getQueryApagarMedicamento(input.getRlUtilizadorMedicamento());	
		}
